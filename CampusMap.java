...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new House ("Wilson House" , "1 Paradise Road" , 4, true));
        ...
        myMap.addBuilding(new House ("Cutter House" , "10 Prospect St" , 3, true));
        myMap.addBuilding(new Building("Boathouse" , null));
        myMap.addBuilding(new Building("Mendenhall", "122 Green St"));
        myMap.addBuilding(new House("Northrop House" , "49 Elm Street" , 4, true));
        myMap.addBuilding(new House("Ziskind House", "10 Prospect St.", 3, true));
